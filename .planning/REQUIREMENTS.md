...
- [x] **PROV-02**: Admin user is created on the provisioned instance with the organizer's email
- [x] **PROV-03**: Unique password is auto-generated and organizer receives a one-time login link to set their own password
