...
**Success Criteria** (what must be TRUE):
  ...
  3. config_exclude_modules excludes demo and web3 modules from config sync
...
- [ ] 10-02-PLAN.md -- Fix config/sync completeness + simplify entrypoint to use drush deploy (Wave 2, depends on 10-01)
- [ ] 10-03-PLAN.md -- Verify cross-file consistency + update SKILL.md + human verification (Wave 3, depends on 10-02)
